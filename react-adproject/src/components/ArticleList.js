...
export default class ArticleList extends Component {
    ...
    onBookmarkClickListener(article){
        ArticleService.bookmarkArticle(article);
    }
                                                ...
                                                <div className="container mt-3">
                                                    <div className="row">
                                                        <div className="col order-first">
                                                            <button className="py-2 mb-2 btn btn-outline-dark rounded-4" type="submit" onClick={() => this.onBookmarkClickListener(article)}>
